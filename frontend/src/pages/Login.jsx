      ...
      <div class="w-full max-w-md">
        {
          state === 'Login'
            ? <div class="text-center mb-10">
              <img class="mx-auto h-12 w-auto" src={assets.cottage_logo} alt="Bonda Cottage" />
              <h2 class="mt-6 text-3xl font-bold tracking-tight text-gray-900">Welcome Back to Bonda Cottage</h2>
          ...
          <div class="bg-white py-8 px-6 shadow rounded-lg">
            <form class="space-y-6" onSubmit={onSubmitHandler}>
              <div>
                ...
                <div class="mt-1">
                  <input onChange={(e) => setName(e.target.value)} value={name} id="fullname" name="fullname" type="text" required="" class="block w-full px-4 py-2.5 border border-gray-300 rounded-button text-gray-900 placeholder-gray-500 focus:border-custom focus:ring-custom sm:text-sm" placeholder="John Doe" />
                </div>
              </div>
              <div>
                <label for="email" class="block text-sm font-medium text-gray-700">Email address</label>
                <div class="mt-1">
                  <input onChange={(e) => setEmail(e.target.value)} value={email} id="email" name="email" type="email" autocomplete="email" required="" class="block w-full px-4 py-2.5 border border-gray-300 rounded-button text-gray-900 placeholder-gray-500 focus:border-custom focus:ring-custom sm:text-sm" placeholder="you@example.com" />
                </div>
              </div>
              <div>
                <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
