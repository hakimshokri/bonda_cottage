...
const ForgotPassword = () => {
    ...
    const { cottages, getCottagesData, backendUrl, token, searchData, setSearchData, userData, setUserData, setForgotPasswordEmail} = useContext(AppContext)
        ...
        <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 mt-8">
            <div class="sm:mx-auto sm:w-full sm:max-w-md">
                <a class="flex justify-center mb-8">
                    <img class="h-16 w-auto" src={assets.cottage_logo} alt="Logo" />
                </a>
